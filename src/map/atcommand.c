...
ACMD(go)
{
	...
	const struct {
		...
		{ MAP_PAYON,       169, 100, 3 }, //  3 = Payon
		{ MAP_ALBERTA,      28, 234, 3 }, //  4 = Alberta
		{ MAP_IZLUDE,      128, 143, 3 }, //  5 = Izlude
		...
		{ MAP_JAWAII,      251, 132, 3 }, // 16 = Jawaii
		{ MAP_AYOTHAYA,    208, 166, 3 }, // 17 = Ayothaya
		{ MAP_EINBROCH,     64, 200, 5 }, // 18 = Einbroch
		{ MAP_LIGHTHALZEN, 158,  92, 3 }, // 19 = Lighthalzen
		{ MAP_EINBECH,      63,  35, 5 }, // 20 = Einbech
		{ MAP_HUGEL,        96, 145, 3 }, // 21 = Hugel
		{ MAP_RACHEL,      130, 110, 3 }, // 22 = Rachel
		{ MAP_VEINS,       216, 123, 3 }, // 23 = Veins
		{ MAP_MOSCOVIA,    223, 184, 3 }, // 24 = Moscovia
		{ MAP_MIDCAMP,     210, 288, 3 }, // 25 = Midgard Camp
		{ MAP_MANUK,       282, 138, 3 }, // 26 = Manuk
		{ MAP_SPLENDIDE,   201, 147, 3 }, // 27 = Splendide
	};
